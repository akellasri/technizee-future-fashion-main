...
const ProductDetail = () => {
  ...
  // NEW: local UI state for size & color selection
  ...
  // NEW: keep live camera readiness here (no stale closure)
  ...
  const capturePortraitFrame = async () => {
    try {
      ...
      if (!videoEl || videoEl.readyState < 2) {
        // Only warn if we *really* think camera isn't ready (manual click too early)
        if (!isVideoReadyRef.current) {
          toast({
            title: "Camera not ready",
        ...
        <Card className="w-full max-w-6xl p-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="flex flex-col items-center">
              ...
              >
                {/* Show webcam OR captured image in the SAME box */}
                {capturedImage ? (
                  <img
                    src={capturedImage}
                    alt="Captured"
                  ...
                  <Webcam
                    ...
                    onUserMedia={() => {
                      ...
                      isVideoReadyRef.current = true;   // NEW

                      // wait 6 seconds after camera becomes active → then start auto countdown
                      setTimeout(() => {
                        if (!capturedImage) {
                          startCountdown(5); // auto countdown, now without false “not ready” toast
                        }
                      }, 6000);
                    }}
                ...
                {/* Countdown only while camera is active */}
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="grid md:grid-cols-2 gap-10">
          ...
          {/* RIGHT: product details + description UI */}
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                High-quality product with perfect fit and comfort.
              </p>
